...
\pgfkeys{
  ...
  title=Purity,
   y tick label style={/pgf/number format/.cd,
        ...
        fixed zerofill,
        precision=2,
        /tikz/.cd},    ]    \addplot coordinates {(Words, 0.72727) (Words and DP,0.711835) (Words and PA,0.761149) (Words and DP and PA,0.729845) };
    \addplot coordinates {(Words, 0.761149) (Words and DP,0.699828) (Words and PA,0.786878) (Words and DP and PA,0.75) }; \legend{Binary, TF-IDF}
     \end{axis}
  \end{tikzpicture}\end{figure}
...
\pgfkeys{
  ...
  title=Normalized Mutual Information,
   y tick label style={/pgf/number format/.cd,
        ...
        fixed zerofill,
        precision=2,
        /tikz/.cd},    ]    \addplot coordinates {(Words, 0.44211) (Words and DP,0.42011) (Words and PA,0.490585) (Words and DP and PA,0.442120) };
    \addplot coordinates {(Words, 0.50932) (Words and DP,0.34044) (Words and PA,0.5485359) (Words and DP and PA,0.491923) }; \legend{Binary, TF-IDF}
     \end{axis}
  \end{tikzpicture}\end{figure}
...
\pgfkeys{
  ...
  title=Adjusted Rand Index,
   y tick label style={/pgf/number format/.cd,
        ...
        fixed zerofill,
        precision=2,
        /tikz/.cd},    ]    \addplot coordinates {(Words, 0.20537) (Words and DP,0.15659) (Words and PA,0.32799) (Words and DP and PA,0.22446) };
    \addplot coordinates {(Words, 0.33894) (Words and DP,0.05001) (Words and PA,0.37705) (Words and DP and PA,0.30966) }; \legend{Binary, TF-IDF}
     \end{axis}
  \end{tikzpicture}\end{figure}
