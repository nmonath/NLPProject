...
Output = Retrieval.RunExhaustive(Features, '../data_sets/brown_retrieval', TopK=15, train_test='train')
...
Output = Retrieval.RunEKD('../data_sets/brown_retrieval', model, train_test='train',TopK=15)

print ('\n'+ '%' *80 + '\n') 
print ('\n'+ '%' *80 + '\n') 

print("PAD")
Output = Retrieval.RunPAD('../data_sets/brown_retrieval', model, train_test='train',TopK=15)
