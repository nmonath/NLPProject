...
\item \label{Using semi-structured data for assessing research paper similarity} \href{http://sci2s.ugr.es/publications/ficheros/HurtadoINS.pdf}{\it Using semi-structured data for assessing research paper similarity} by Germán Hurtado Martína, Steven Schockaert, Chris Cornelis, Helga Naessens 

\item \label{Finding similar research papers using language models} \href{http://www.cwi.ugent.be/Chris/article_iswc_spim2011.pdf}{\it Finding similar research papers using language models} by Germán Hurtado Martína, Steven Schockaert, Chris Cornelis, Helga Naessens 
